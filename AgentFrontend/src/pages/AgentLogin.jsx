            ...
            <div className="brand-header">
                <div className="brand-logo">
                    ...
                    <div className="brand-text">
                        <h1 className="brand-title">Pashudhan Suraksha</h1>
                        <p className="brand-subtitle">Livestock Insurance Solutions</p>
                    </div>
                </div>
            </div>
                ...
                <form onSubmit={handleLogin}>
                    ...
                    <div className="text-center mt-4">
                        <p className="text-sm text-muted">
                            Not a partner yet? <Link to="/register" style={{ color: 'var(--primary-color)', fontWeight: '600' }}>Join Network</Link>
                        </p>
