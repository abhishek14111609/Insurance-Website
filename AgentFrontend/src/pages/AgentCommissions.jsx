...
const AgentCommissions = () => {
    ...
    const handleExport = () => {
        try {
            ...
            const formattedData = formatCommissionsForExport(filteredCommissions);
            exportToCSV(formattedData, 'my_commissions');
            toast.success(`Exported ${filteredCommissions.length} commissions successfully`);
        } catch (error) {
